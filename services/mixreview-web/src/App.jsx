  ...
  const handleAudioUpload = useCallback(async (file, requestedTrackId = null) => {
    ...
    try {
      ...
      const nextAudioSource = normalizeAudioSource({
        ...
        requiresTranscode: uploadResult.requiresTranscode,
        previewUrl: uploadResult.previewUrl,
        previewKey: uploadResult.previewKey,
        peaksUrl: uploadResult.peaksUrl,
        duration: uploadResult.duration,
        processingStatus: uploadResult.processingStatus,
        previewStatus: uploadResult.previewStatus,
        peaksStatus: uploadResult.peaksStatus,
        durationStatus: uploadResult.durationStatus,
        processingError: uploadResult.processingError,
        previewBitrate: uploadResult.previewBitrate,
        previewFormat: uploadResult.previewFormat,
...
function hydrateStoredVersion(version) {
  ...
  return {
    ...
    duration: version.duration || version.audioMetadata?.duration || 0
  };
}
