...
export function toStoredAudioMetadata(audioSource) {
  ...
  return {
    ...
    playbackUrl: url,
    audioUrl: url,
    originalUrl: audioSource.originalUrl || url,
    originalFormat: audioSource.originalFormat || null,
    ...
    duration: typeof audioSource.duration === "number" ? audioSource.duration : null,
    processingStatus: audioSource.processingStatus || null,
    previewStatus: audioSource.previewStatus || null,
    peaksStatus: audioSource.peaksStatus || null,
    durationStatus: audioSource.durationStatus || null,
    processingError: audioSource.processingError || null,
    previewBitrate: audioSource.previewBitrate || null,
    previewFormat: audioSource.previewFormat || null,
...
function normalizeAudioMetadata(audioMetadata) {
  ...
  return {
    ...
    playbackUrl: typeof audioMetadata.playbackUrl === "string" && audioMetadata.playbackUrl ? audioMetadata.playbackUrl : null,
    audioUrl: typeof audioMetadata.audioUrl === "string" && audioMetadata.audioUrl ? audioMetadata.audioUrl : null,
    originalUrl: typeof audioMetadata.originalUrl === "string" && audioMetadata.originalUrl ? audioMetadata.originalUrl : null,
    originalFormat: typeof audioMetadata.originalFormat === "string" && audioMetadata.originalFormat ? audioMetadata.originalFormat : null,
    ...
    duration: typeof audioMetadata.duration === "number" ? audioMetadata.duration : null,
    processingStatus: typeof audioMetadata.processingStatus === "string" && audioMetadata.processingStatus ? audioMetadata.processingStatus : null,
    previewStatus: typeof audioMetadata.previewStatus === "string" && audioMetadata.previewStatus ? audioMetadata.previewStatus : null,
    peaksStatus: typeof audioMetadata.peaksStatus === "string" && audioMetadata.peaksStatus ? audioMetadata.peaksStatus : null,
    durationStatus: typeof audioMetadata.durationStatus === "string" && audioMetadata.durationStatus ? audioMetadata.durationStatus : null,
    processingError: typeof audioMetadata.processingError === "string" && audioMetadata.processingError ? audioMetadata.processingError : null,
    previewBitrate: typeof audioMetadata.previewBitrate === "string" && audioMetadata.previewBitrate ? audioMetadata.previewBitrate : null,
    previewFormat: typeof audioMetadata.previewFormat === "string" && audioMetadata.previewFormat ? audioMetadata.previewFormat : null,
